...
-- PARA O TRATAMENTO DE NULL UTILIZAR AS EXPRESSÕES IS NULL OU NOT NULL
-- PARA TRATAMENTO DE VALORES NULL PODEM SER UTILIZADAS AS FUNÇÕES NVL OU A NVL2
-- NVL SUBSTITUI O VALOR NULO POR UM VALOR DA EMPRESSÃO EX: NVL(EXMPRESSION1, EXPRESSION2)
-- NVL2 SUBISTITUI O VALOR DA EXPRESSÃO POR UM VALOR NÃO NULO OU NULO EX: NVL2(EXPRESSION1, SENÃONULO_EXPRESSAO2, SENULO_EXPRESSÃO3)
