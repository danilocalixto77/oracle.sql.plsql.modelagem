...
-- Essa array é destinada a records, desta forma cada linha dela irá armazenar todos valores de um registro 
-- que tenha sido consultado de uma tabela.
-- Usar este tipo com moderação por não é aconselhavel pois o BULK carrega toda tabela.
-- Tipo de array/collection mais utilizado no mercado. Conforme experiência do instrutor.
