...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('vnumero1 = ' || vNumero1);  -- ImpressÃ£o do Primeiro Número
  DBMS_OUTPUT.PUT_LINE('vnumero2 = ' || vNumero2);  -- ImpressÃ£o do Segundo Número
  DBMS_OUTPUT.PUT_LINE('Media = ' || vMedia);     -- ImpressÃ£o da Média calculada 
END;
