...
/*
OS PARAMETROS SÃO DECLARADOS LOGO APÓS A DECLARAÇÃO DO CURSO
OS VALORES DO PARÂMETROS SÃO INFORMADO DENTRO DO OPEN
*/
SET SERVEROUTPUT ON
SET VERIFY OFF
DECLARE
  ...
  WHERE   department_id = pdepartment_id  AND
          job_id = pjob_id;
BEGIN
  FOR employees_record IN  employees_cursor (60, 'IT_PROG') --VALORES DOS PARÂMETROS
  LOOP
