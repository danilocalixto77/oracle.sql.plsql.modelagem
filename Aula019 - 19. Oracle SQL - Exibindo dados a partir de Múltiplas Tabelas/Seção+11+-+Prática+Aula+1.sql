...
-- Faz a consulta buscando os campos que são comuns entre as tabelas como o 
-- mesmo nome também o mesmo tipo.
-- JOIN não muito comum de utilizar.
SELECT  department_id, department_name, location_id, city
FROM    departments
NATURAL JOIN locations;

-- JOIN com a Cláusula USING
-- Utilizando esta cláusula USING o campo que faz o relacionamento entre as tabelas
-- não pode ter alias nem o nome da tabela como prefixo antes do campo.
